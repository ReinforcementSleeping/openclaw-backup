...
class WsConnectionManager {
    constructor(logger, heartbeatInterval = 30000, reconnectBaseDelay = 1000, maxReconnectAttempts = 10, wsUrl, wsOptions) {
        this.ws = null;
...
class WSClient extends EventEmitter {
    constructor(options) {
        ...
        // 初始化 WebSocket 管理器
        this.wsManager = new WsConnectionManager(this.logger, this.options.heartbeatInterval, this.options.reconnectInterval, this.options.maxReconnectAttempts, this.options.wsUrl || undefined, this.options.wsOptions);
        // 设置认证凭证
